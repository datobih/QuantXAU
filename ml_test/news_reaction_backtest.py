...
# CONFIG
# =============================================================================
# Read from the environment; never hard-code credentials in source.
#   Windows:  setx FRED_API_KEY "your_key_here"     (then reopen the terminal)
...
if not FRED_API_KEY:
    raise SystemExit("FRED_API_KEY is not set. Export it in your environment "
                     "(see CONFIG at the top of this file) and re-run.")
